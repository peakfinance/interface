...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(peakFinance.PSHARE, peakFinance.contracts.Masonry.address);

  const tokenBalance = useTokenBalance(peakFinance.PSHARE);
  const stakedBalance = useStakedBalanceOnMasonry();
  const { from, to } = useUnstakeTimerMasonry();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('PRO', peakFinance.PSHARE);
